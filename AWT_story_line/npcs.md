...
8. **Transition text:** *The painting is larger than it looked. Or you are smaller. The tavern in the frame tilts toward you, and then you are simply there — the smell of woodsmoke and ale arriving before anything else does.*

**Tower exit sarcasm** (random, if player asks how to leave):
1. *Will doesn't look up. "Guild hall," he says. Just those two words. Then silence.*
2. *"I dispatched you on a quest involving a cursed ring and a man whose roof it fell through, and your first obstacle is... leaving the room." He picks his pen back up. "Take your time."*
3. *"The tower does not have a front door per se. Look around. I find that helps."*
...
### Kevry Talborn
**Location:** Small island, 69 squares east in the Open Ocean.
...
### May
**Location:** The Bar, Tale and Ale Tavern.
**Personality:** Tall, fit, shoulder-length red hair, late 30s, tomboyish. Sells hints, introduces Quest Board.
...
Vendor: sells gunpowder (5Z), Tip Journal (5Z), Fishing Rod (8Z). Buyback at half price for his items only. `TALK TO SHAMUS` to buy or sell.
...
**Subsequent visits (before werewolf defeated):**

*"'The lower passages.' That's all I have. That's the last thing."*

**After werewolf defeated:**

She looks at you for a moment when you come in.

*"'It's not a dead end — it's* a beginning.'"*

She picks up her book. *"He said that once, about a research problem. I think about it."*
...
### Calder Finch
Deceased. Ancestor of Rowan Finch. Explored the dungeon extensively. Left the Middle Tier Key behind. His gravestone was stolen (Quest 32). Likely donated early treasure items to the Trophy Case — Rowan should acknowledge this.

---

### Silas Bryne
Lighthouse keeper. **Unmet NPC — never appears in game.** Referenced only in May's Tier 2 post-visit hint for Quest 17. Found the Unbind Undead scroll, couldn't make heads or tails of it, left it on his desk. This is why the scroll is accessible at the Lighthouse.
...
- Warriors/Rogues: bring scroll to Will Passion (scroll consumed, spell learned permanently)
- Cannot wear Enchanted Glasses in Will's presence during teaching
