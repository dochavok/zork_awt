...
|Archery Range                   |Edge of town; hazardous — Vikings at the nearby encampment fire arrows at anyone passing through. Challenge roll to avoid being hit. Permanently safe once the player earns the Vikings' trust (all three encampment trials complete).|
|**Viking Encampment**           |Off the Archery Range. Followers of The Brotherhood of the Pale Blade. The Vikings will not give the player the runed metal until trust is earned through three trials. Trials may be attempted in any order. All three must be completed before the runed metal is awarded. The runed metal must then be taken to Pyronicus's forge — Pyronicus forges it into a **Pale Blade**. The Pale Blade is the artifact consumed in The Brotherhood of the Pale Blade ring ritual at the Church of All altar.|
|— The Encampment                |Main camp area. Fire pit, longhouses, Vikings going about their business. Hostile to strangers until trust trials are complete. Tone TBD — description needed.|
|— The Riddle Stone              |A runic inscription poses a riddle: *"I have no legs but travel far. I have no mouth but swallow ships. I have no hands but I will take everything you own if you let me. What am I?"* Answer: `SEA`. Player must type the answer to pass. **Actually Enchanted Glasses:** Kevry's voice whispers the answer. Wrong answers can be retried. Completing this trial counts as one of three trust trials.|
|— The Ritual Circle             |Five rune stones arranged around a symbol on the ground. Must be activated in the correct order — encoded somewhere in the encampment (TBD). Wrong order resets. Correct order completes the ritual and counts as one of three trust trials. **Open question:** Exact mechanic and order-clue location to be tweaked — flagged for review.|
|— The Fire Pit                  |Drinking challenge. A strength-based challenge roll against the Viking champion. Rogues and Warriors get class bonuses TBD. Winning counts as one of three trust trials. Viking champion reacts warmly on losing — respects the player for lasting as long as they did.|
...
|**The Chuckle House**           |A funhouse. Location in Roundabout TBD. Multiple rooms, each featuring mirrors with different mechanics. The invisibility/ring mechanic is central. Description TBD — needs dedicated design pass for layout and tone.|
|— The Entrance                  |TBD — entry room, sets the tone.|
|— The Rejection Mirror          |A mirror that repels visible players — stepping in front of it while visible sends the player back to the previous room. Passing while invisible (ring worn) proceeds normally. The **ghost** is tied to this room — visible only while wearing the ring. The ghost asks the player to return a pocket watch to his family. **Ghost quest mechanics:** (1) Mages — ghost teaches the spell directly. (2) Warriors/Rogues — ghost gives a scroll; player takes it to Will Passion to learn (cannot wear Enchanted Glasses in Will's presence). Spell TBD. The ghost has no connection to the Chuckle House — he is simply tied to this mirror.|
|— The Shatter Trap Mirror       |A mirror rigged with a crossbow behind the frame. Examining it too closely without disarming triggers the crossbow. Perception check spots the firing pin at the mirror's edge; disarming requires removing the bolt from its housing before touching the mirror face. (Trap 16)|
|**May's hints — Ghost/Watch quest:**|**Tier 1:** People say the mirrors in the Chuckle House show more than they should. Most folks don't go back a second time. **Tier 2:** Word is a family member of the records room clerk went into the Chuckle House years ago and never came out. He doesn't talk about it. **Tier 3:** The trick with the Chuckle House is that some doors only open for people the mirrors can't find.|
...
|— The Lighthouse                |Dead-end room off Roundabout Beach to the north, perpendicular to the main town↔docks axis. **Open question:** Quests 14 and 23 both involve lighthouse keepers but are inconsistent — Quest 14 has a male keeper on a cliff near Kevry's sea approach; Quest 23 has a female keeper near the sea cliffs with a cave accessible from the beach. Resolve whether this is one keeper or two, and redesign both quests around the lighthouse location. Flag for dedicated design pass.|
...
- [ ] Chuckle House — location in Roundabout; entrance room; additional mirror rooms; ghost dialogue TBD.
...
- [ ] Viking Encampment — room description; ritual circle clue location and order; drinking challenge class bonuses.
