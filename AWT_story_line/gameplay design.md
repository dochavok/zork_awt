...
|— Lost Apprentice's Cell        |Quest 50: combat with afflicted apprentice; post-combat `USE SHOVEL` finishes hole to Bog-NW; apprentice follows player out; Apprentice's Gloves reward (hands slot, +3 combat roll bonus); quest completes on bog exit.|
